        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              InfoContainer(icon: Icons.person_rounded, title: "Username", subtitle: user.username),
              const SizedBox(height: 20),
              InfoContainer(icon: Icons.location_on_rounded, title: "Address", subtitle: user.location),
              const SizedBox(height: 20),
              InfoContainer(icon: FontAwesomeIcons.phone, title: "Phone", subtitle: user.phone.toString()),
              const SizedBox(height: 20),
